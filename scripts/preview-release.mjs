...
function getCurrentVersion() {
  try {
    ...
    // (e.g. "1.2.3"). This repo's tags are already bare, but semver.inc()
    // also returns without a prefix — keeping both in sync avoids a
    // double-prefix in the PR comment's display strings.
